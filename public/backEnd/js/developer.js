...
function addRowMark() {
    ...
    newRow += "<input class='primary-input form-control' type='text' placeholder='title' id='exam_title' name='exam_title[]' value='Practical' autocomplete='off' required>";
    ...
    newRow += "<td class='border-top-0'>";
    newRow += "<div class='input-effect'>";
    newRow += "<input class='primary-input form-control exam_mark' type='number' id='exam_mark' name='exam_mark[]' value='0' autocomplete='off' required>";
    newRow += "</div>";
    newRow += "</td> ";
    newRow += "</td>";
    newRow += "<td class='border-top-0'>";
    newRow += "<div class='input-effect'>";
    newRow += "<input class='primary-input form-control exam_pass_mark' type='number' id='exam_pass_mark' value='0' name='exam_pass_mark[]' autocomplete='off' required>";
    newRow += "</div>";
    newRow += "</td> ";
...
$(document).on("keyup", ".exam_pass_mark", function (event) {

    var totalMarks = 0;
    $('tr#row1 input[name^="exam_pass_mark"]').each(function () {
        if ($(this).val() != "") {
            totalMarks += parseInt($(this).val());
        }
    });
    $('td#totalPassMark input').val(totalMarks);
});
