...
Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
    ...
    // Fees by Lavel
    Route::get('fees-by-class', ['as' => 'fees_by_lavel', 'uses' => 'SmFeesByLavelController@index']);
    Route::post('fees-by-class-store', ['as' => 'fees_by_class_store', 'uses' => 'SmFeesByLavelController@store']);
    Route::get('fees-by-class-delete-{fee_id}', ['as' => 'fees_by_class_delete', 'uses' => 'SmFeesByLavelController@delete']);


    // scholarship route
    Route::get('scholarship-create', ['as' => 'scholarship_create', 'uses' => 'SmScholarshipController@index']);
    Route::post('scholarship-store', ['as' => 'scholarship_store', 'uses' => 'SmScholarshipController@store']);
    Route::get('scholarship-edit-{scholarship_id}', ['as' => 'scholarship_edit', 'uses' => 'SmScholarshipController@edit']);
    Route::get('scholarship-delete-{scholarship_id}', ['as' => 'scholarship_delete', 'uses' => 'SmScholarshipController@delete']);
    Route::post('scholarship-update-{scholarship_id}', ['as' => 'scholarship_update', 'uses' => 'SmScholarshipController@update']);


    // credit bill issue routes
    Route::get('bill-create', ['as' => 'bill_create', 'uses' => 'SmBillIssueController@index']);
    Route::get('section-{class_id}', ['as' => 'get_section', 'uses' => 'SmBillIssueController@getSection']);
    Route::get('fee-{class_id}', ['as' => 'get_fee', 'uses' => 'SmBillIssueController@getFees']);
    Route::get('student-{class_id}', ['as' => 'get_student', 'uses' => 'SmBillIssueController@getStudent']);
    Route::get('rate-{fee_id}', ['as' => 'get_rate', 'uses' => 'SmBillIssueController@getFeeTypeRate']);
    Route::get('students-{class_id}-{section_id}', ['as' => 'get_student_bysection', 'uses' => 'SmBillIssueController@getStudentBySection']);
    Route::post('bill-save', ['as' => 'bill_save', 'uses' => 'SmBillIssueController@creditBillSave']);

    // khalti integration
    Route::post('generatebill', ['as' => 'generatebill', 'uses' => 'SmBillIssueController@generateBill']);
    Route::post('payemnt/Khalti/sucess', ['as' => 'payment_success', 'uses' => 'SmBillIssueController@paymentKhaltiSuccess']);

    // eSewa integration
    Route::get('esewa-pay', ['as' => 'esewa_pay', 'uses' => 'SmBillIssueController@esewaPay']);

    // bill pay through admin
    Route::post('bill-by-admin', ['as' => 'bill_by_admin', 'uses' => 'SmBillIssueController@billPayByAdmin']);
   


    // fiscal year route
    Route::get('fiscal-year', ['as' => 'fiscal_year', 'uses' => 'SmFiscalYearController@index']);
    Route::post('fiscal-store', ['as' => 'fiscal_store', 'uses' => 'SmFiscalYearController@store']);
    Route::post('fiscal-{id}', ['as' => 'fiscal_update', 'uses' => 'SmFiscalYearController@update']);
    Route::get('fiscal-{id}', ['as' => 'fiscal_year_edit', 'uses' => 'SmFiscalYearController@edit']);
    Route::get('fiscal-delete-{id}', ['as' => 'fiscal_delete', 'uses' => 'SmFiscalYearController@delete']);
    ...
    Route::get('paid/fees/{id}', ['as' => 'payment_search', 'uses' => 'SmFeesController@paidFeeByStudet']);
    ...
    Route::get('session/make/default/{id}', ['as' => 'session_make_default', 'uses' => 'SmSessionController@sessionMakeDefault']);
...
// Route::group(['middleware' => ['StudentMiddleware']], function () {
    ...
    Route::get('student_dashboard', ['as' => 'student_dashboard', 'uses' => 'Student\SmStudentPanelController@studentDashboard']);
    ...
    // fees
    Route::get('student_fees', ['as' => 'student_fees', 'uses' => 'Student\SmFeesController@studentFees']);
    ...
    //student Result
    Route::get('student_result', ['as' => 'student_result', 'uses' => 'Student\SmStudentPanelController@studentResult']);

    //student Exam Schedule
    Route::get('student_exam_schedule', ['as' => 'student_exam_schedule', 'uses' => 'Student\SmStudentPanelController@studentExamSchedule']);
